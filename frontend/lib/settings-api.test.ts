...
import { handleGet, handlePost, manageSnsSubscription } from "../app/api/user/settings/route";
...
async function runTests() {
    ...
    try {
        ...
        expect(data1.profile.emailNotificationsEnabled, false, "Should have notifications disabled by default");
        passed++;
        ...
        expect(data2.profile.notificationEmail, "test@example.com", "Should save notification email");
        expect(data2.profile.emailNotificationsEnabled, true, "Should save notification toggle");
        passed++;
        ...
        expect(data3.profile.notificationEmail, "test@example.com", "GET should return updated email");
        expect(data3.profile.emailNotificationsEnabled, true, "GET should return updated toggle");
        passed++;
