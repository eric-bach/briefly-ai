      ...
      Footer() {
        ...
        useEffect(() => {
          const disableSignInButton = () => {
            ...
            if (
              signInButton &&
              signInButton.textContent?.trim() === "Sign in"
            ) {
              ...
              signInButton.style.cursor = shouldDisable
                ? "not-allowed"
                : "pointer";
      ...
      Footer() {
        ...
        useEffect(() => {
          const disableSignUpButton = () => {
            ...
            if (
              signUpButton &&
              signUpButton.textContent?.trim() === "Create Account"
            ) {
              const shouldDisable = turnstileStatus !== "success";

              signUpButton.disabled = shouldDisable;
              signUpButton.style.opacity = shouldDisable ? "0.5" : "1";
              signUpButton.style.cursor = shouldDisable
                ? "not-allowed"
                : "pointer";
